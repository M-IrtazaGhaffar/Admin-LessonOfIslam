    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <div>
          ...
          pariatur, ea, beatae quasi eaque, assumenda odit facilis. Ullam, ipsum
          officiis? Omnis obcaecati quod est consectetur commodi, dolores
          officia. Iusto sapiente, natus neque aspernatur odit cupiditate
          ratione? Exercitationem, quia. Atque eligendi temporibus ipsa adipisci
          nesciunt voluptate laboriosam nemo, pariatur soluta fugiat obcaecati
          inventore iusto? Sequi, reprehenderit! Magni consequuntur temporibus
          ipsum? Accusantium, atque! Ducimus hic, ratione, dolore itaque
          consequuntur odit similique assumenda porro commodi iure qui, autem
          perspiciatis quidem! Libero facere quidem unde.
        </div>
      </Box>
    </Box>
  );
